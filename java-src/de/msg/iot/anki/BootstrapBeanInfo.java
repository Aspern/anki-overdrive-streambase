 ...
 */
public class BootstrapBeanInfo extends SBSimpleBeanInfo {

	/*
	 * The order of properties below determines the order they are displayed
	 * within the StreamBase Studio property view.
	 */
